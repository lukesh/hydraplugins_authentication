	...
	public class RestrictionRetrieveCommand extends SimpleCommand implements IResponder {
		...
		public function result(data:Object):void {
			if (data is ResultEvent) {
				this.facade.sendNotification(new Notification(AuthenticationManager.RESTRICTION_RETRIEVE, IPrincipal(data.result), Phase.RESPONSE));
			} else if (data is IPrincipal) {
				this.facade.sendNotification(new Notification(AuthenticationManager.RESTRICTION_RETRIEVE, IPrincipal(data), Phase.RESPONSE));
			}
		}
